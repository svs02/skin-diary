...
시니어 QA. 실제 사용자 흐름과 edge case에 집중하고 Mock 남용을 경계한다.
...
- [ ] 매우 어두운/밝은 사진 → 규격화 동작
- [ ] 같은 날에 두 탭에서 동시 쓰기 → last-write-wins 검증
...
4. **Draft Recovery**: 기록 중 브라우저 닫기 → 재접속 → draft 복원 (localStorage + Firestore 양쪽)
